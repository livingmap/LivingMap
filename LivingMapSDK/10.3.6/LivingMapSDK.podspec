Pod::Spec.new do |spec|
  ...
  spec.summary                    = 'LivingMapSDK 10.3.6 for iOS10.0 and above'
  spec.source                     = {:http => 'https://github.com/livingmap/LivingMap/releases/download/SDKv10.3.6/LivingMapSDK.xcframework.zip'
  }
