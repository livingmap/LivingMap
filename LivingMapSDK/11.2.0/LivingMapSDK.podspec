Pod::Spec.new do |spec|
  ...
  spec.summary                    = 'LivingMapSDK 11.2.0 for iOS 13.0 and above'
  spec.source                     = { :http => 'https://github.com/livingmap/LivingMap/releases/download/11.2.0/LivingMapSDK.xcframework.zip'}
