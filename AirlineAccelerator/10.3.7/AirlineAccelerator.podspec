Pod::Spec.new do |spec|
  ...
  spec.summary                    = 'LivingMap AirlineAccelerator 10.3.7 for iOS 10.0 and above'
  spec.source                     = { :http => 'https://github.com/livingmap/distribution-iOS/releases/download/AAv10.3.7/AirlineAccelerator.xcframework.zip'}
