Pod::Spec.new do |spec|
  ...
  spec.summary                    = 'LivingMap AviationAccelerator 11.3.2 for iOS 13.4 and above'
  spec.source                     = { :http => 'https://github.com/livingmap/LivingMap/releases/download/11.3.2/AviationAccelerator.xcframework.zip'}
