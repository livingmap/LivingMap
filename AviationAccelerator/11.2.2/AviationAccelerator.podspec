Pod::Spec.new do |spec|
  ...
  spec.summary                    = 'LivingMap AviationAccelerator 11.2.2 for iOS 13.0 and above'
  spec.source                     = { :http => 'https://github.com/livingmap/LivingMap/releases/download/11.2.2/AviationAccelerator.xcframework.zip'}
