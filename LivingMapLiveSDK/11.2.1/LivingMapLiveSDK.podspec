Pod::Spec.new do |spec|
  ...
  spec.summary                    = 'LivingMapLiveSDK 11.2.1 for iOS 13.0 and above'
  spec.source                     = { :http => 'https://github.com/livingmap/LivingMap/releases/download/11.2.1/LivingMapLiveSDK.xcframework.zip'}
