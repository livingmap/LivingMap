Pod::Spec.new do |spec|
  ...
  spec.summary                    = 'LivingMapLiveSDK 11.1.0-alpha for iOS 13.0 and above'
  spec.source                     = { :http => 'https://github.com/livingmap/LivingMap/releases/download/11.1.0-alpha/LivingMapLiveSDK.xcframework.zip'}
